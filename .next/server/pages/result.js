...
const Result = ()=>{
    ...
    const { 0: url , 1: setUrl  } = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)();
    const user = (0,_store__WEBPACK_IMPORTED_MODULE_4__/* .useAppSelector */ .CG)((state)=>state.user.portfolioUrl
    );
    console.log(user, "user");
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                className: "mx-auto text-3xl items-center text-center py-10",
                children: "Here is your portfolio Link"
            }),
            user && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(next_link__WEBPACK_IMPORTED_MODULE_2__["default"], {
                href: user,
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,162], () => (__webpack_exec__(4811)));
